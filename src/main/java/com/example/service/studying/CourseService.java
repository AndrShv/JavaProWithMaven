...
public class CourseService {
    ...
    public CourseResponse createCourse(CourseRequest request, String teacherUsername) {
        ...
        System.out.println("Course successfully saved: " + savedCourse.getName());

        String notificationText = "A new course has been created: " + savedCourse.getName();
    ...
    public CourseResponse updateCourse(Long courseId, CourseRequest request, String teacherUsername) {
        ...
        if (!course.getTeacher().getTeacherName().equals(teacherUsername)) {
        ...
        course.setName(request.getTitle());
        course.setDescription(request.getDescription());
        System.out.println("Course successfully updated: " + course.getName());
